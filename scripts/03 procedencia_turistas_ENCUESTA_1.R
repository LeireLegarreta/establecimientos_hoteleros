...
entradas2018 <- subset(entradas, entradas$FECHA> "2018-01-01" & entradas$FECHA < "2019-01-01")

entradas2019 <- subset(entradas, entradas$FECHA> "2019-01-01" & entradas$FECHA < "2020-01-01")

entradas2020 <- subset(entradas, entradas$FECHA> "2020-01-01" & entradas$FECHA < "2021-01-01")

str(entradas2018)

colSums(entradas2018[,c(14:56)], na.rm = T)
colSums(entradas2019[,c(14:56)], na.rm = T)
colSums(entradas2020[,c(14:56)], na.rm = T)
...
server <- function(input, output, session) {
  ...
  output$world_chor1 <- renderLeaflet({
    ...
    bins=c(0,1000,5000,10000,50000,100000,Inf)
